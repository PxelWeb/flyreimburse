                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Pay Process Applications</h4>
                        </div>
                        <div class="card-body">
                            <form id="filter-form" class="form-inline mb-3" action="{{ route('excel.in-pay-process') }}">
...
@push('scripts')
    ...
    <script>
        document.getElementById('filter-button').addEventListener('click', function () {
            ...
            window.LaravelDataTables["inpayprocess-table"].ajax.url(
                window.LaravelDataTables["inpayprocess-table"].ajax.url().split('?')[0] + 
