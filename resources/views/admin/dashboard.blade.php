...
@section('content')
    <section class="section">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <a href="{{ route('admin.new-arrival-application') }}">
                    <div class="card card-statistic-1">
                        <div class="card-icon bg-primary">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <a href="{{ route('admin.delivered-application') }}">
                    <div class="card card-statistic-1">
                        <div class="card-icon bg-primary">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <a href="{{ route('admin.in-pay-process-application') }}">
                    <div class="card card-statistic-1">
                        <div class="card-icon bg-primary">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <a href="{{ route('admin.refused-application') }}">
                    <div class="card card-statistic-1">
                        <div class="card-icon bg-primary">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <a href="{{ route('admin.completed-application') }}">
                    <div class="card card-statistic-1">
                        <div class="card-icon bg-primary">
