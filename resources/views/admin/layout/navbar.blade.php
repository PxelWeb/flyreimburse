@php
    $applications = App\Models\Application::orderBy('created_at','desc')->take(10)->get();
    $seen = App\Models\Application::where('seen',0)->count();
    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg {{ $seen > 0 ? 'beep' : '' }}"><i class="far fa-bell"></i></a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                ...
                @foreach ($applications as $application)
                    <a href="{{ route('admin.application-details',$application->id) }}" class="dropdown-item dropdown-item-unread">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="{{ route('admin.email-config.index') }}" class="dropdown-item has-icon">
