                          ...
                          <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="btn-group btn-group-toggle status" data-toggle="buttons">
                                      <label  data-id="{{ $applicationDetail->id }}" class="btn btn-secondary{{ $applicationDetail->status == 'new_arrival' ? ' active' : '' }}">
                                      <input type="radio" name="status" id="new" value="new_arrival" autocomplete="off"> New application
                                      </label>
                                      <label data-id="{{ $applicationDetail->id }}" class="btn btn-secondary{{ $applicationDetail->status == 'delivered' ? ' active' : '' }}">
                                      <input type="radio" name="status" id="delivered" value="delivered" autocomplete="off"> Delivered
                                      </label>
                                      <label data-id="{{ $applicationDetail->id }}" class="btn btn-secondary{{ $applicationDetail->status == 'in_pay_process' ? ' active' : '' }}">
                                      <input type="radio" name="status" id="pay" value="in_pay_process" autocomplete="off"> In pay process
                                      </label>
                                      <label data-id="{{ $applicationDetail->id }}" class="btn btn-secondary{{ $applicationDetail->status == 'refused' ? ' active' : '' }}">
                                      <input type="radio" name="status" id="refused" value="refused" autocomplete="off"> Refused
                                      </label>
                                      <label data-id="{{ $applicationDetail->id }}" class="btn btn-secondary{{ $applicationDetail->status == 'completed' ? ' active' : '' }}">
                                      ...
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                         <div class="container">
                                            ...
                                            <img src="{{ asset('nomad-application.jpg') }}"  alt="Logo" class="logo" style="width: 200px;margin-left: 600px;">
                                            </div>
                                            <div class="title">
...
$('.btn-generate-pdf').click(function() {
    ...
    $.ajax({
      method: 'GET',
      url: '{{ route('admin.nomad-application.pdf') }}',
      data: {
        id : id,
        username: username,
        sign: sign
