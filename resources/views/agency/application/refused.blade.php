            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="filter-form" class="form-inline mb-3" action="{{ route('excel.refused') }}">
...
@push('scripts')
    ...
    <script>
        document.getElementById('filter-button').addEventListener('click', function () {
            ...
            window.LaravelDataTables["refused-table"].ajax.url(
                window.LaravelDataTables["refused-table"].ajax.url().split('?')[0] + 
