<form id="denied-boarding-1" class="submit-form">
    ...
    <div class="horizontal-container">
      ...
      <div class="calendar-input">
        ...
        <input type="date" id="date" required name="date" onfocus="this.max = new Date().toISOString().split('T')[0]">
      ...
      <div class="search-box airlines-search-box">
        ...
        <input type="text" id="airline" required placeholder="Airlines" name="airline" class="search-input3 airlineInput">
      </div>
    </div>
    ...
    <div class="input-container1">
      ...
      <input type="file" id="boarding_pass" name="boarding_pass" class="upload-input" required accept="image/*,.jpg,.jpeg,.png,.pdf">
    </div>

    <div class="input-container1">
        <label for="uploadFile" class="upload-label">
          <i class="fas fa-upload"></i>Denied Boarding Form/Denied Boarding
        </label>
        <input type="file" id="boarding_pass" name="denied_boarding" class="upload-input" required accept="image/*,.jpg,.jpeg,.png,.pdf">
      </div>
