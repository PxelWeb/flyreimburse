...
<body class="bg-light">
  <div dir="ltr">﻿<div style="width:600px">
    ...
    <div style="text-align:center;font-family:'Segoe UI';font-size:11.5;margin-left:50px;margin-right:50px">
        Hi {{ explode(',',$name)[0] }}!<br>

        We are pleased to inform you that your reimbursement request has been completed successfully.<br>
        The payment has been processed and should be reflected in your account shortly.<br>
        Thank you for your patience and for using Fly Reimburse!<br>
