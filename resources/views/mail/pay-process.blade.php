...
<body class="bg-light">
  <div dir="ltr">﻿<div style="width:600px">
    ...
    <div style="text-align:center;font-family:'Segoe UI';font-size:11.5;margin-left:50px;margin-right:50px">
      ...
      Good news! Your reimbursement request is now in the payment process.<br>
      Our finance team is processing your payment, and you should receive it soon.<br>
      We appreciate your patience during this time.<br>
      Thank you for using Fly Reimburse!<br>
      Best regards,
    </div>
